...
function IndexPage(){
  ...
  return (
  <Layout title="Home">
    <div className='flex flex-col mx-auto items-start justify-start h-full pt-10 gap-3 max-w-3xl px-10'>
      ...
      <p className='text-white text-lg'>
        My name is Mo, I just finished my masters degree in Computer Science at RWTH Aachen University and this is my website (WIP)!
      </p>
      <p className='text-white text-lg'>
